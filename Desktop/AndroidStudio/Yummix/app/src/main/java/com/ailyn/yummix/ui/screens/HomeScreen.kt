        ...
        BoxWithConstraints(
            ...
            if (isTablet) {
                ...
                Row(modifier = Modifier.fillMaxSize()) {
                    ...
                    Image(
                        painter = painterResource(id = R.drawable.imageninicio_tablet),
                    ...
                    Box(
                        ...
                        Image(
                            painter = painterResource(id = R.drawable.onda_derechatablet),
                            contentDescription = "Decoración derecha",
